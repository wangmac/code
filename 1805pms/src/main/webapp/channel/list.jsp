...
<div class="box-positon">
	...
	<form class="ropt">
		<input class="add" type="button" value="添加" onclick="javascript:window.location.href='channeltochannel.do'"/>
	</form>
...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<tbody class="pn-ltbody">
		<c:forEach items="${channels }" var="channel">
			...
			<td align="center">${channel.isleaf}</td>
			<td align="center">${channel.sort}</td>
			<td align="center">
			<a href="channelgetbyid.do?id=${channel.id }" class="pn-opt">修改</a>
